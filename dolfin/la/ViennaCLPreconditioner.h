...
namespace dolfin
{
  ...
  //
  // To overcome the serial nature of ILU0 applied to the full system matrix, 
  // a parallel variant is to apply ILU to diagonal blocks of the system matrix. 
  class ViennaCLPreconditionerBlockILU0 : public ViennaCLPreconditioner
  {
  public:

    /// Create a ILU to diagonal blocks of the system matrix preconditioning object
    explicit ViennaCLPreconditionerBlockILU0( std::string type ) : ViennaCLPreconditioner(type)
    {};
  ...
  //
  // To overcome the serial nature of ILUT applied to the full system matrix, 
  // a parallel variant is to apply ILU to diagonal blocks of the system matrix. 
  class ViennaCLPreconditionerBlockILUT : public ViennaCLPreconditioner
  {
  public:

    /// Create a ILU to diagonal blocks of the system matrix preconditioning object
    explicit ViennaCLPreconditionerBlockILUT( std::string type ) : ViennaCLPreconditioner(type)
    {};
  ...
  //
  // 
  // Row scaling is a simple diagonal preconditioner given by the reciprocals of 
  // the norms of the rows of the system matrix
  class ViennaCLPreconditionerRowScaling : public ViennaCLPreconditioner
  {
  public:

    /// Create a Row scaling preconditioner object
    explicit ViennaCLPreconditionerRowScaling( std::string type ) : ViennaCLPreconditioner(type)
    {};
